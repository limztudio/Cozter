...
class CopilotBackend(Backend):
    ...
    # catalog. These are the slugs documented by the CLI command reference;
    # availability still depends on the user's Copilot plan and organization
    # policy. Models documented only for other Copilot surfaces are omitted.
    available_models = (
        "auto",
        "claude-sonnet-4.6",
        "gpt-5.4",
